      ...
      a(href = link, class = "no-format",
        fluidRow(class = "domain-box", #height = 200,
          ...
          column(width = 12, class = "dataset-txt", align = "center",
            h4(strong(data$title)), p(data$desc)) #from yaml
          )
        )
      ),
  ...
  fluidRow(
    column(width = 12,
      ...
      p(class = "lead",
            ...
            "power analysis, and experimental planning for voice patterns in neuropsychiatric disorders")
      )
    )
  )
...
fluidRow(class = "domain-info2",
  column(width = 3),
  column(width = 12,
    map(3, #seq(1, ceiling(length(domains) / 4), 1
      ~ tagList(
        fluidRow(
