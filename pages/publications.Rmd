---
pagetitle: MetaVoice Publications
---
...
2. For referencing the use of MetaVoice, please also cite the MetaVoice website: 
...
4. Since the MetaVoice site is continuously updated, we recommend that you list the date of download for your data in your manuscript. For example: "We analyse all data currently in MetaVoice (Nyholm Jensen & Dwenger, 2020). Data were downloaded on YYYY-MM-DD."
...
The feature descriptions used on the [analyses tools](./analyses.html) have been created based using the following papers:
