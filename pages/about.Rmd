...
fullWidthPanelBox(
  "MetaLab",
  HTML("This website was built on the basis of the code provided by the MetaLab team, which can be found <a href='https://github.com/langcog/metalab2/'>on GitHub</a>. Thank you for sharing your code, knowledge and ideas.")
)
