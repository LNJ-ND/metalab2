...
fullWidthPanelBox(
  "MetaLab",
  p("This website was buildt on the basis of the code provided by the MetaLab team, which can be found on <a href='https://github.com/langcog/metalab2/'>on GitHub</a>. Thank you for sharing your code, knowledge and ideas.")
)

fullWidthPanelBox(
  "Source code",
  HTML("The source2 for this website can be found <a href='https://github.com/LNJ-ND/MetaVoice_Website'>on GitHub</a>. The website itself is hosted through GitHub Pages, with the accompanying visualizations hosted on a Shiny server.")
)
```
