...
fullWidthPanelBox(
  "Metalab",
  p("This website was built on the basis of the code provided by the Metalab team, which can be found on <a href='https://github.com/langcog/metalab2/'> GitHub</a>. Thank you for sharing your code, knowledge and ideas.")
)
