---
params:
  dataset: !r data.frame(name=character(2), short_name=character(2), num_papers=integer(2), num_experiments=integer(2), num_subjects=integer(2), stringsAsFactors = FALSE)
