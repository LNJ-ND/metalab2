...
params:
  dataset: !r data.frame(name=character(1), short_name=character(1), num_papers=integer(1), num_experiments=integer(1), num_subjects=integer(1), stringsAsFactors = FALSE)
