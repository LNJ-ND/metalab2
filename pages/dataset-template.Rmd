...
fluidRow(
  column(width = 12,
    ...
    tags$ul(
      ...
      tags$li(paste("Last updated:"), dataset_info$last_update),
      tags$li(paste("Curator(s):"), dataset_info$curator),
      ...
      tags$li(strong("Voice features:", dataset_info$voice_features))
    ))
```
